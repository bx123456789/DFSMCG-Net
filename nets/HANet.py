...
class HAN(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        c3 = torch.cat([(self.cam_attention_3(c3_1) + self.row_attention_3(self.col_attention_3(c3_1))), self.Up1(c4)],
                       1)
        ...
        c2 = torch.cat([(self.cam_attention_2(c2_1) + self.row_attention_2(self.col_attention_2(c2_1))), self.Up1(c3)],
                       1)
        ...
        c1 = torch.cat([(self.cam_attention_1(c1_1) + self.row_attention_1(self.col_attention_1(c1_1))), self.Up1(c2)],
                       1)
