...
import nets.resnet as models
from nets.help_funcs import Transformer, TransformerDecoder, TwoLayerConv2d
...
class BASE_Transformer(ResNet):
    ...
    def forward(self, x1, x2):
        ...
        x1 = self.forward_single1(x1)
        x2 = self.forward_single2(x2)
...
def get_model_memory_usage(model, input_tensor1,input_tensor2):
    # 清理CUDA缓存
